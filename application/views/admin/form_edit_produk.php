		...
		<div class="row">
			<div class="col-md-4">
                ...
                <div class="form-group">
					...
					<span class="check">
						<label><input type="radio" name="jenis" <?php echo ($produk->jenis == 'barang') ? "checked":"" ?> value="barang"> Barang</label>&nbsp;
						<label><input type="radio" name="jenis" <?php echo ($produk->jenis == 'jasa') ? "checked":"" ?> value="jasa"> Jasa</label>&nbsp;
						<label><input type="radio" name="jenis" <?php echo ($produk->jenis == 'paket') ? "checked":"" ?> value="paket"> Paket</label>&nbsp;
						<label><input type="radio" name="jenis" <?php echo ($produk->jenis == 'promo') ? "checked":"" ?> value="promo"> Promo</label>
					</span>
				</div>
