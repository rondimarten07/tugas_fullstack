...
<div class="row">
    <div class="col col-xl-12 pull-right">
...
<!-- 
            ...
            <a href="<?php echo site_url('admin/produk/jenis/paket') ?>"
                class="btn btn-default <?php echo $url_jenis == 'paket' ? 'active disabled' : '' ?>">Paket <span
                    class="badge"><?php echo $total_paket ?></a>
            <a href="<?php echo site_url('admin/produk/jenis/promo') ?>"
                class="btn btn-default <?php echo $url_jenis == 'promo' ? 'active disabled' : '' ?>">Promo <span
                    class="badge"><?php echo $total_promo ?></a> -->
