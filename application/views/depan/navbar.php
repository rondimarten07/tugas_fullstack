            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="<?php echo ($page == 'produk') ? 'active' : '' ?>"><a href="<?php echo site_url('produk') ?>">Makanan</a></li>
                        <li class="<?php echo ($page == 'jasa') ? 'active' : '' ?>"><a href="<?php echo site_url('jasa') ?>">Minuman</a></li>
                    </ul>
                </li>
            </ul>
